...
<body>
	...
	<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		...
		<ul class="nav menu">
			...
			<li class="active"><a href="petugas.php"><em class="fa fa-user">&nbsp;</em> Petugas</a></li>
    ...
    <div class="row g-5 mb-4">
      ...
      <div class="row justify-content-end">
          <div class="col-md-6">
            <a href="tambah_petugas.php" class="btn btn-primary float-end" id="addBarangBtn"><i class="bi bi-plus-lg"></i> Tambah
              Data</a>
          </div>
        </div>
              ...
              <tbody class="text-center">
                ...
                ?>
                  <tr id="table-data">
                    ...
                    <td>
                      <a href="edit_petugas.php?id=<?php echo $result['id']; ?>" class="fa fa-pencil-square"></a>
                      <a href="hapus_petugas.php?id=<?php echo $result['id']; ?>" onclick="return confirm('Apakah anda akan menghapus <?php echo $result['username']; ?>?')" class="fa fa-trash"></a>
                    </td>
                  </tr>
                <?php } ?>
        ...
        <div class="modal-body">
          <form method="post" action="proses_tambah_petugas.php">
            <div class="mb-3">
              ...
              <input type="text" name="petugas" class="form-control" id="barang" required>
            </div>
            <div class="mb-3">
              <label class="form-label">Username</label>
              <input type="text" name="username" class="form-control" id="alamat" required>
            </div>
            <div class="mb-3">
              <label class="form-label">Password</label>
              <input type="text" name="password" class="form-control" id="satuan" required>
            </div>
