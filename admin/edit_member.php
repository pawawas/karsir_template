                    ...
                    <div class="card-body">
                        <form method="post" action="proses_edit_member.php">
                            <div class="mb-3">
                                ...
                                <input type="text" name="nama" class="form-control" id="barang" value="<?php echo $result['NamaPelanggan']; ?>" required>
                            </div>
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="nomer" class="form-control" id="nomer" value="<?php echo $result['NomorTelepon']; ?>" required>
                            </div>
