...
<body>
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
		...
		<div class="row">
			<div class="col-lg-12">
				<h1 class="page-header">Tambah Data Member</h1>
			</div>
		</div><!--/.row-->
        ...
        <div class="card mt-2">
          ...
          <form method="post" action="proses_tambah_member.php">
                            ...
                            <div class="mb-3">
                                ...
                                <textarea rows="3" type="text" name="alamat" class="form-control" id="alamat" required>
								</textarea>
                            </div>
                            <div class="mb-3">
                                <label class="form-label">Nomor Telepon</label>
                                <input type="number" name="nomer" class="form-control" id="nomer"  required>
                            </div>
